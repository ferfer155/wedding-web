...
const EventCard: React.FC<EventCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-2 rounded-t-[132px] rounded-b-lg border pointer-events-none ${
          isPrimary
      ...
      <div className="px-8 pt-16 pb-10 flex flex-col items-center text-center space-y-6 relative z-10">
        <div className="space-y-2">
          <p
            className={`font-sans text-[0.55rem] tracking-[0.3em] uppercase ${
              isPrimary
          ...
          <h4
            className={`font-script text-[3.5rem] leading-[0.8] ${
              isPrimary
                ? "text-[var(--color-gold-light)]"
        ...
        <div className="space-y-4 w-full">
          ...
          <div className="flex flex-col gap-3 items-center">
            ...
            >
              ...
              <span className="font-serif text-[0.95rem] tracking-wide">
                {date}
              </span>
            </div>
          ...
          >
            ...
            />
            <p
              className={`font-serif font-medium text-[1.1rem] mb-1 ${
            ...
            <p
              className={`font-serif italic text-[0.85rem] leading-relaxed mx-auto max-w-[220px] ${
...
export const EventDetails: React.FC = () => {
  return (
    <section className="py-20 w-full">
      <div
        className="animate-section text-center space-y-6 mb-16"
        data-anim="fade-up"
      >
